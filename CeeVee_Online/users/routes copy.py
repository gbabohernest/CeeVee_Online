...
from CeeVee_Online.users.forms import SignUpForm, SignInForm, User, Role, ResetPasswordForm, RequestResetForm, PostingForm
...
def product(listing_id):
    ...
    # Pass the laptop_parts list to the template
    return render_template('product.html', **template_data, laptop_list=laptop_list, listing_id=listing_id)
...
def laptops():
    ...
    return render_template('laptops.html', **template_data, laptop_list=laptop_list, title='Categories')
...
def posting():
    ...
    return render_template('posting.html', **template_data, laptop_data=laptop_data, laptop_list=laptop_list, form=form, title='posting')
...
def postings():
    template_data = get_data_for_templates()
    laptop_list = table_to_dict(laptops_listing)
    return render_template('postings.html', **template_data, laptop_list=laptop_list, title='Categories')
...
def listings():
    template_data = get_data_for_templates()
    laptop_list = table_to_dict(laptops_listing)
    return render_template('listings.html', **template_data, laptop_list=laptop_list, title='Listings')
...
def payment():
    template_data = get_data_for_templates()
    return render_template('payment.html', **template_data, laptop_list=laptop_list, title='Payment')
